...
export const RadioGroup = React.forwardRef<HTMLFieldSetElement, RadioGroupProps>(
  ({ className, name, legend, options, selectedValue, onChangeValue, error, required = false, ...props }, ref) => {
    return (
      <fieldset
        ref={ref}
            ...
            return (
              ...
              >
                <input
                  ...
                  className="h-6 w-6 cursor-pointer text-accent focus:ring-accent accent-accent"
                />
